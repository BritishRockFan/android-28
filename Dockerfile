...
ENV PATH "${PATH}:${ANDROID_HOME}/build-tools/32.0.2"
...
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "system-images;android-28;android-tv;x86"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/sdkmanager "--update"
RUN /opt/android-sdk-linux/cmdline-tools/tools/bin/avdmanager create avd -n AndroidTV_28 --abi android-tv/x86 --package "system-images;android-28;android-tv;x86" --device "tv_1080p"
